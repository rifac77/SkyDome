...
export class CascadedShadowGenerator extends ShadowGenerator {
     ...
     */
    constructor(mapSize, light, usefulFloatFirst) {
    ...
    static Parse(parsedShadowGenerator, scene) {
        const shadowGenerator = ShadowGenerator.Parse(parsedShadowGenerator, scene, (mapSize, light) => new CascadedShadowGenerator(mapSize, light));
